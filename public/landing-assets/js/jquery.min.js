                    ...
                    ! function (t, n) {
                        ...
                        ! function () {
                            ...
                            for (e in Z.matches = function (e, t) {
                                    ...
                                    preFilter: {
                                        ATTR: function (e) {
                                            return e[1] = e[1].replace(Q, Y), e[3] = (e[3] || e[4] || e[5] || "").replace(Q, Y), "~=" === e[2] && (e[3] = " " + e[3] + " "), e.slice(0, 4)
                                        },
                                        CHILD: function (e) {
                                    ...
                                    pseudos: {
                                        ...
                                        contains: te((function (e) {
                                            return e = e.replace(Q, Y),
                                                function (t) {
                                                    return (t.textContent || E.text(t)).indexOf(e) > -1
                                                }
                                        })),
                                        lang: te((function (e) {
                                            return B.test(e || "") || Z.error("unsupported lang: " + e), e = e.replace(Q, Y).toLowerCase(),
                                                function (t) {
                                                    var n;
                                                    do {
                            ...
                            function me(e, n, r, i) {
                                ...
                                if (r = r || [], 1 === p.length) {
                                    if ((a = p[0] = p[0].slice(0)).length > 2 && "ID" === (s = a[0]).type && 9 === n.nodeType && f && t.relative[a[1].type]) {
                                        if (!(n = (t.find.ID(s.matches[0].replace(Q, Y), n) || [])[0])) return r;
                                        c && (n = n.parentNode), e = e.slice(a.shift().value.length)
                                    }
                                    for (o = z.needsContext.test(e) ? 0 : a.length; o-- && (s = a[o], !t.relative[u = s.type]);)
                                        if ((l = t.find[u]) && (i = l(s.matches[0].replace(Q, Y), G.test(a[0].type) && se(n.parentNode) || n))) {
                                    ...
                                    i = {
                                        ...
                                        then: function (e, n, i) {
                                                    ...
                                                    var s = this,
                                                        ...
                                                        l = function () {
                                                            ...
                                                            if (!(e < o)) {
                                                                ...
                                                                l = r && ("object" == typeof r || "function" == typeof r) && r.then, y(l) ? i ? l.call(r, a(o, t, G, i), a(o, t, Q, i)) : (o++, l.call(r, a(o, t, G, i), a(o, t, Q, i), a(o, t, G, t.notifyWith))) : (n !== G && (s = void 0, u = [r]), (i || t.resolveWith)(s, u))
                                                            }
                                                        },
                                                        c = i ? l : function () {
                                                            try {
                                                                ...
                                                                E.Deferred.exceptionHook && E.Deferred.exceptionHook(r, c.error), e + 1 >= o && (n !== Q && (s = void 0, u = [r]), t.rejectWith(s, u))
                                                            }
                                                        };
                                            ...
                                            return E.Deferred((function (r) {
                                                t[0][3].add(a(0, r, y(i) ? i : G, r.notifyWith)), t[1][3].add(a(0, r, y(e) ? e : G)), t[2][3].add(a(0, r, y(n) ? n : Q))
                                            })).promise()
                                        },
                                        promise: function (e) {
                        ...
                        function Ze(e, t, n) {
                            var r, i, o, a, s = Qe.test(t),
                                u = e.style;
                            return (n = n || Ye(e)) && (a = n.getPropertyValue(t) || n[t], s && a && (a = a.replace(L, "$1") || void 0), "" !== a || ve(e) || (a = E.style(e, t)), !v.pixelBoxStyles() && Ge.test(a) && Ke.test(t) && (r = u.width, i = u.minWidth, o = u.maxWidth, u.minWidth = u.maxWidth = u.width = a, a = n.width, u.width = r, u.minWidth = i, u.maxWidth = o)), void 0 !== a ? a + "" : a
                        }
                        ...
                        E.extend({
                            ...
                            css: function (e, t, n, r) {
                                var i, o, a, s = ie(t);
                                return Qe.test(t) || (t = it(s)), (a = E.cssHooks[t] || E.cssHooks[s]) && "get" in a && (i = a.get(e, !0, n)), void 0 === i && (i = Ze(e, t, r)), "normal" === i && t in st && (i = st[t]), "" === n || n ? (o = parseFloat(i), !0 === n || isFinite(o) ? o || 0 : i) : i
                            }
                            ...
                            css: function (e, t) {
                                return ee(this, (function (e, t, n) {
                                    var r, i, o = {},
                                        a = 0;
                                    if (Array.isArray(t)) {
                                        for (r = Ye(e), i = t.length; a < i; a++) o[t[a]] = E.css(e, t[a], !1, r);
                                        return o
                                    }
                        ...
                        Gt.href = Dt.href, E.extend({
                            ...
                            ajax: function (e, t) {
                                ...
                                if (d.data && d.processData && "string" != typeof d.data && (d.data = E.param(d.data, d.traditional)), Yt(Xt, d, t, C), l) return C;
                                ...
                                if (T = "abort", y.add(d.complete), C.done(d.success), C.fail(d.error), n = Yt(Ut, d, t, C)) {
